...
\subsection{}
	...
	\end{eqnarray}
    Assuming the sum to follow a Gaussian distribution  the prob of having a sum $\ge$ 100 is tot value of sigma away which means a probability of cazzi.

    Using a MC simulation bla bla bla bla.

    The prob is esitameted for ddiferent number of tries.
    \begin{figure}[h]
    	\begin{center}
