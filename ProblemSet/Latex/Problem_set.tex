...
\section{Distributions \& \\ probabilities} % (fold)
	...
	\begin{figure}[h]
		\begin{center}
			\includegraphics[width=.42 \textwidth]{fig/lil.pdf}
		\end{center}
...
\label{sec:monte_carlo}
 ...
 The transformation method would not work as the integral of the PDF:
 \begin{multline}
 	\int_{-\infty}^{x(r)} \frac{2}{x^{3}}\, dx = - \frac{1}{x(r)^{2}} = r
 \end{multline}
is not invertible.
Hit or miss or combination or both!
